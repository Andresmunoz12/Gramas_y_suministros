...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Evergreen', description: 'Marca del fabricante' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Polietileno', description: 'Material principal' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateProductoDto.prototype, "material", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 45000, description: 'Precio unitario' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], CreateProductoDto.prototype, "altura", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'ID de la categoría (Relación)' }),
